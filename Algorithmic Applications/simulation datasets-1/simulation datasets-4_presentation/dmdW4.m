...
rel_error = norm(W4 - X_dmd, 'fro') / norm(W4, 'fro');
...
exportgraphics(gcf, 'dmd_modes_W4_lowfreq_highgrowth_energy_top4.png', 'Resolution', 300);
...
for k = 1:Nt
    ...
    view(-90,30);
    title(sprintf('Original W4, Frame %d / %d', k, Nt));
